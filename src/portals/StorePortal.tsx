...
import { Inbox, History, CheckCircle2, Package, Send, User, Phone, Power } from 'lucide-react';
                  ...
                  <div className="flex items-center space-x-2 mt-2 text-[9px]">
                    ...
                    {o.driverId && (
                      <span className="flex items-center space-x-1 text-emerald-400">
                        ...
                        <span>{drivers.find(d => d.id === o.driverId)?.name || o.driverId} · {drivers.find(d => d.id === o.driverId)?.phone || '—'}</span>
                      </span>
                    )}
                  </div>
                </div>
        ...
        <div className="space-y-3">
          ...
          <div className="bg-[#101d30] border border-[#1e3050] rounded-2xl p-4 space-y-2.5">
            <div className="flex items-center justify-between">
              ...
              <span className="text-[11px] font-bold text-white">{profile.storeName || 'Smart Shop'}</span>
            </div>
            <div className="flex items-center justify-between">
            ...
            <div className="flex items-center justify-between">
              ...
              <span className="text-[11px] font-bold text-white">{orders.length}</span>
            </div>
          </div>
