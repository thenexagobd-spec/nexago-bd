...
export default function App() {
  ...
  const staffCardHtml = (card: any) => `<!doctype html><html><head><meta charset="utf-8"><title>${card.id} Staff ID</title><style>
    ...
    .qr{width:16mm;height:16mm;background:white;border-radius:1.5mm;padding:1.2mm;display:grid;place-items:center;align-self:center}.qr svg{width:100%;height:100%}.photoBar{background:white;border:1px solid #e5e7eb;border-radius:1mm;width:25mm;height:7mm;margin-top:1mm;overflow:hidden}.photoBar img{width:100%;height:100%;object-fit:fill;display:block}.foot{position:absolute;left:5mm;right:5mm;bottom:3mm;border-top:1px solid rgba(255,255,255,.2);padding-top:1mm;display:flex;justify-content:space-between;font-size:6px;font-weight:700;color:rgba(255,255,255,.75)}
                      ...
                      <div className="relative flex h-full flex-col justify-between">
                        ...
                        <div className="grid grid-cols-[96px_minmax(0,1fr)_64px] items-end gap-3">
                          <div className="w-24 shrink-0">
                            ...
                            <div className="mt-1 h-8 w-24 overflow-hidden rounded border border-gray-200 bg-white">
