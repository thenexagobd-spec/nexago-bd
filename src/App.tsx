                    ...
                    <div className="relative aspect-[85.6/54] overflow-hidden rounded-2xl border border-white/20 bg-gradient-to-br from-[#07111f] via-[#102138] to-[#f97316] p-4 shadow-2xl">
                      ...
                      <div className="relative flex h-full flex-col justify-between">
                        ...
                        <div className="grid grid-cols-[96px_minmax(0,1fr)_64px] items-end gap-3">
                          ...
                          <div className="flex h-16 w-16 items-center justify-center self-center rounded-md bg-white p-1">
                              <QRCodeSVG value={staffCardVerifyUrl(staffIdCard)} size={56} level="M" marginSize={0} bgColor="#ffffff" fgColor="#0b1220" />
                          </div>
                        </div>
